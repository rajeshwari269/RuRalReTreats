...
// Toggle Subscription Plan Pricing (Monthly/Yearly)
...
toggleSwitch.addEventListener("click", () => {
    ...
    if (toggleSwitch.classList.contains("active")) {
        priceBasic.textContent = "$100/year";
        priceStandard.textContent = "$200/year";
        pricePremium.textContent = "$300/year";
    } else {
        priceBasic.textContent = "$10/month";
        priceStandard.textContent = "$20/month";
        pricePremium.textContent = "$30/month";
    }
});
